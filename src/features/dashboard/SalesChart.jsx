...
function SalesChart({ bookings, numDays }) {
  ...
  // eachDayOfInterval() → returns an array containing every date between start & end.
  ...
  const data = allDays.map((date) => {
    return {
      ...
      totalSales: bookings
        //Filter=> Keep only bookings where: The booking’s creation date matches the current date.
